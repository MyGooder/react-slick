    ...
    render() {
      return (
        <WrappedComponent
          ...
          swipeMove={this.swipeMove}
          getNavigableIndexes={this.getNavigableIndexes}
          checkNavigable={this.checkNavigable}
          getSlideCount={this.getSlideCount}
          swipeEnd={this.swipeEnd}
          onInnerSliderEnter={this.onInnerSliderEnter}
          onInnerSliderOver={this.onInnerSliderOver}
          onInnerSliderLeave={this.onInnerSliderLeave}
        />
      )
    }
  }
